  ...
  return (
    <div className=''>
        ...
        <div className="bg-slate-300 flex gap-[100px] justify-between items-center py-[70px] px-[90px] sm:px-[16px] sm:flex-col sm:py-[40px] sm:gap-7 md:px-[30px] md:gap-0 md:py-[50px] lg:px-[60px] lg:py-[50px] lg:gap-[0]">
          <div className="w-[50%] mr-[60px] sm:w-[100%] sm:mr-0 md:w-[100%] md:mr-4 ">
            ...
            <div className="flex justify-between gap-4 mt-10 sm:flex-col sm:mt-8 md:mt-5 md:gap-3 ">
              <div className="">
                <div className='text-[40px] md:text-[35px] sm:text-[35px] text-black'>
                <RiBox2Line/>
                 </div>
              ...
              <div className="">
                <div className='text-[40px] sm:mt-2 md:text-[35px] sm:text-[35px] text-black'>
                <RiBox2Line/>
                </div>
        ...
        <div 
         ...
         className="w-[500px] h-[600px] rounded-[10px] bg-red-600 bg-cover bg-center sm:w-[100%] sm:bg-green-500 sm:h-[450px] md:w-[100%] md:h-[500px] lg:h-[500px]">
          ...
          <div className="w-[50%] ml-[60px] sm:w-[100%] sm:ml-0 md:w-[100%] md:ml-4">
            <h1 className='font-bold text-[40px] mb-4 line48 sm:text-4xl md:text-4xl lg:text-4xl text-[#0D3859]'>Save Time and Access Test Results Online with Our Laboratory Booking Webapp.</h1>
            ...
            <div className="flex items-center gap-2 my-3 md:items-start lg:items-start text-black">
              <RiBox2Line/>
              <p className='text-[16px] md:text-[14px] text-black'>Convenient access to test results through our online platform.</p>
            </div>
            <div className="flex items-center gap-2 md:items-start lg:items-start text-black">
            <RiBox2Line/>
      ...
      <section className="">
        <div className="bg-slate-400 py-[60px]  text-[black] px-[90px] text-center sm:px-[16px] sm:py-[45px] md:px-[30px] md:py-[50px] lg:px-[60px] lg:py-[50px]">
          <h1 className="font-bold text-[3rem] mb-6 sm:text-4xl md:text-4xl md:mb-4 text-[#0D3859]">Book Your Lab Tests Online</h1>
            ...
            <div className="">
              <button className='bg-[#4EB2E4] text-[white] text-white border-[black] py-2 px-4 mr-2 rounded-[10px] md:text-[15px]'
              onClick={handleSignup}
              >Register</button>
              <button className='bg-transparent text-black border border-[#4EB2E4] py-2 px-4 rounded-[10px] md:text-[15px]'>Learn More</button>
          </div>
        </div>
      </section>
      {/* <section className="">
      ...
      <section className=''>
        ...
        <section>
        <div className="bg-[#4EB2E4] flex justify-between py-[100px] px-[90px] sm:flex-col sm:gap-4 sm:px-[16px] sm:py-[40px] md:px-[30px] md:py-[50px] lg:px-[60px] lg:py-[50px]">
          <div className="">
          ...
          <div className="flex">
            ...
            <button className='bg-transparent text-[white] border border-[black] h-12 py-2 px-4 rounded-[10px] md:h-12 md:text-[15px] lg:h-10 lg:text-[15px]'>Contact</button>
          </div>
        </div>
        </section>
    </div>

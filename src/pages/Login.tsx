       ...
       <div className='bg-[#0D3859] h-[600px] w-[450px] m-auto rounded-[10px] sm:hidden md:hidden'>
        ...
        <div className='flex flex-col gap-4 mx-10 mt-10 sm:mt-0 md:mt-0 sm:w-screen sm:mx-4 md:w-screen md:mx-6'>
            ...
            <input type="email"
             ...
             required
            className="bg-white text-black placeholder:text-slate-400 outline-[#4EB2E4] p-4 h-[60px] w-[400px] border-slate-400 border-[1px] rounded-[30px] sm:h-[45px] sm:w-full md:h-[45px] md:w-full" 
            placeholder='Email' />
            </div>
            <div className="mx-4 mb-2">
            <input type="password" 
